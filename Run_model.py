...
results_df=pd.DataFrame(results, columns=['iteration', 'Step', 'AgentID', 'flood_map_choice', 'network', 'information_policy_type', 'total_households_state_0', 'total_households_state_1', 'total_households_state_2', 'total_households_state_3', 'total_households_state_4', 'flood_damage_actual'])
...
g = sns.PairGrid(results_filtered, y_vars=["total_households_state_0", "total_households_state_1", "total_households_state_2", "total_households_state_3"], x_vars=["Step"], hue="information_policy_type", height=4)
g.map(sns.lineplot)
g.add_legend()

scatter_map = sns.FacetGrid(results_filtered, col="flood_map_choice", height=4)
scatter_map.map(sns.scatterplot, "iteration", "flood_damage_actual")
